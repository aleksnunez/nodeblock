...
const calculateHash = ({ previousHash, timestamp, data, nonce = 1 }) => 
    CryptoJS.SHA256(previousHash + timestamp + JSON.stringify(data) + nonce).toString()
...
document.write(JSON.stringify(generateGenesisBlock()));
console.log(generateGenesisBlock());

},{"crypto-js/core":2,"crypto-js/sha256":3}],2:[function(require,module,exports){
...
},{"crypto":4}],3:[function(require,module,exports){
;(function (root, factory) {
	if (typeof exports === "object") {
		// CommonJS
